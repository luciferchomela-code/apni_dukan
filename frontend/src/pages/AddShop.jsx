        ...
        <div className="min-h-screen bg-white flex items-center justify-center px-4 py-12">
            <div className="w-full max-w-xl space-y-10">
                ...
                <div className="text-center space-y-2">
                    <h1 className="text-4xl font-black text-[#4F46E5] tracking-tight">
                        Launch Your Shop
                    </h1>

                    <p className="text-[#475569] font-medium opacity-80 uppercase tracking-widest text-xs">
                        Empower your business with modern tools
                    </p>
                </div>
                    ...
                    <div className="relative group">
                        {previewUrl ? (
                            ...
                            <label className="w-full flex flex-col items-center justify-center h-56 rounded-[2rem] border-2 border-dashed border-gray-100 bg-gray-50/50 hover:bg-red-50/30 hover:border-red-200 cursor-pointer transition-all group">
                                ...
                                <span className="mt-4 text-sm font-bold text-gray-400 group-hover:text-emerald-500 transition-colors uppercase tracking-widest">
                                    Upload Banner
                                </span>

...
const Cart = () => {
    ...
    const { cart, subTotal, quantity, fetchCart, loading, shopLocation, location } = useAppData()
    ...
    const updateQuantity = async (itemId, action) => {
        try {
            ...
            if (method === "post") {
                ...
                const shopId =
                    typeof itemInCart?.shopId === "object"
                        ? itemInCart.shopId._id
                        : itemInCart?.shopId
        ...
        return (
            <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center space-y-8">
                ...
                <p className="text-[#D4AF37] text-[10px] font-black uppercase tracking-[0.6em]">
                    Securely retrieving your selection...
                </p>
                                ...
                                >
                                    ...
                                    <div className="h-40 w-40 flex-shrink-0 bg-[#0A0A0A] overflow-hidden rounded-[0.25rem] border border-[#1F1F1F]">
                                        ...
                                        <img
                                            ...
                                            className="h-full w-full object-contain p-6 mix-blend-lighten"
                                        />
                                    ...
                                    <div className="flex-1 space-y-4 w-full text-center md:text-left">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <h3 className="text-2xl font-serif italic text-[#F8F8F8] tracking-widest uppercase truncate">
                                                {item.itemId.name}
                                            </h3>
                                    ...
                                    <div className="flex flex-col items-center md:items-end gap-6 w-full md:w-auto">
                                        ...
                                        <div className="flex flex-col items-center md:items-end">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-[0.4em] opacity-40 mb-3">
                                                Quantity
                                            </span>
                                            ...
                                            <div className="flex items-center gap-6 bg-[#0A0A0A] border border-[#1F1F1F] px-4 py-2 rounded-full">
                                                ...
                                                <span className="text-xs font-black text-[#D4AF37] min-w-[1rem] text-center">
                                                    {item.quantity}
                                                </span>
                                        ...
                                        <div className="text-right">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-[0.4em] opacity-40 block mb-1">
                                                Value
                                            </span>

                                            <span className="text-2xl font-black text-[#F8F8F8] tracking-tighter">
                    ...
                    <div className="sticky top-40 bg-[#121212] border border-[#1F1F1F] p-12 rounded-[0.25rem] space-y-12 shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
                        ...
                        <div className="space-y-6 border-b border-[#1F1F1F] pb-10">
                            ...
                            <div className="flex justify-between items-center text-xs tracking-wider">
                                ...
                                <span className="opacity-40 uppercase font-black text-[9px]">
                                    Subtotal
                                </span>

                                <span className="text-[#F8F8F8] font-bold">
                                    ₹{subTotal}
                                </span>

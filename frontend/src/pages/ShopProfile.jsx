...
const ShopProfile = ({ shop, isSeller, onUpdate }) => {
                ...
                <AnimatePresence>
                    ...
                    {editMode && (
                        ...
                        >
                            ...
                            <span className="text-[#D4AF37] text-[10px] font-black tracking-[0.4em] uppercase">
                                Update Cover Photo
                            </span>
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        {editMode ? (
                            ...
                            <div className="space-y-2">
                                ...
                                <label className="text-[10px] font-black text-[#D4AF37] uppercase tracking-[0.4em] ml-2">
                                    Shop Name
                                </label>
                            ...
                            <div className='flex items-center gap-4 text-[#A0A0A0] bg-[#1A1A1A] w-fit px-6 py-3 rounded-full border border-[#1F1F1F] shadow-xl'>
                                ...
                                <span className="text-[10px] font-black tracking-[0.2em] uppercase leading-none mt-0.5">
                                    {shop.autoLocation?.formattedAddress || "Location Details Hidden"}
                                </span>

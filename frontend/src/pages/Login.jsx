    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <motion.div
          ...
          className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full bg-[#D4AF37]/10 blur-[120px]"
        />
        <motion.div
          animate={{ scale: [1, 1.15, 1], opacity: [0.2, 0.4, 0.2] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          className="absolute -bottom-32 -right-32 w-[600px] h-[600px] rounded-full bg-[#B8941F]/10 blur-[140px]"
        />
        <motion.div
          animate={{ scale: [1, 1.1, 1], opacity: [0.15, 0.3, 0.15] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 4 }}
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-[#D4AF37]/10 blur-[100px]"
        />
      ...
      >
        <div className="relative rounded-3xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-2xl shadow-2xl shadow-black/60 overflow-hidden p-8">
          ...
          >
            <div className="relative mb-5">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#D4AF37] to-[#B8941F] flex items-center justify-center shadow-lg shadow-[#D4AF37]/20">
                <BiStore className="w-10 h-10 text-[#0A0A0A]" />
              </div>
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#D4AF37] to-[#B8941F] blur-xl opacity-40 -z-10 scale-110" />
            </div>

            <h1 className="text-3xl font-black text-[#F8F8F8] tracking-tight">
              Apni{" "}
          ...
          >
            ...
            >
              <span className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-[#D4AF37]/10 via-transparent to-[#B8941F]/10" />
        ...
        <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#D4AF37]/10 to-[#B8941F]/10 blur-2xl -z-10 scale-105" />
      </motion.div>
    </div>
  );
};

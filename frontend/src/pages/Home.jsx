        ...
        <div className="min-h-screen bg-[#0A0A0A] text-[#A0A0A0] pb-20">
            ...
            <div className="relative h-[40vh] bg-[#0A0A0A] border-b border-[#1F1F1F] overflow-hidden flex flex-col items-center justify-center px-4">
                ...
                >
                    ...
                    <h1 className="text-5xl font-serif text-[#F8F8F8] italic tracking-widest uppercase">
                        The Shops
                    </h1>
                ...
                {shops.length === 0 ? (
                    ...
                    <div className="py-40 flex flex-col items-center justify-center space-y-8 bg-[#121212] border border-[#1F1F1F] rounded-[0.5rem] shadow-2xl">
                        ...
                        <div className="text-center space-y-3">
                            ...
                            <h3 className="text-2xl font-serif text-[#F8F8F8] tracking-widest uppercase italic">
                                No Matches Found
                            </h3>

                            <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-40">
                                Adjust your search parameters or location
                            </p>
                                ...
                                >
                                    ...
                                    <div className="relative h-64 overflow-hidden bg-[#0A0A0A]">
                                        ...
                                        {!shop.isOpen && (
                                            ...
                                            <div className="absolute inset-0 bg-[#0A0A0A]/80 flex items-center justify-center backdrop-blur-[2px]">
                                                ...
                                                <span className="text-red-500 text-[10px] font-black uppercase tracking-[0.5em] border border-red-500/20 px-8 py-4">
                                                    Restricted Access
                                                </span>
                                        ...
                                        <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between z-10">
                                            ...
                                            {shop.distanceKm !== undefined && (
                                                ...
                                                <span className="text-[9px] font-black text-[#A0A0A0] uppercase tracking-[0.2em]">
                                    ...
                                    <div className="p-10 space-y-6">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <h3 className="text-2xl font-serif text-[#F8F8F8] italic tracking-widest uppercase group-hover:text-[#D4AF37] transition-colors">
                                                {shop.name}
                                            </h3>

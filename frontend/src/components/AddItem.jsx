...
const AddItem = ({ onItemAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || "Failed to authenticate item"
      )
    ...
    >
      ...
      <div className='bg-[#121212] rounded-[1rem] border border-[#1F1F1F] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.5)] relative'>
        ...
        <div className='p-10 pb-6 space-y-2'>
          ...
          <h2 className='text-3xl font-black text-[#F8F8F8] tracking-tight uppercase'>
            Add New Item
          </h2>

          <p className='text-[#A0A0A0] text-[10px] font-bold uppercase tracking-[0.3em]'>
        ...
        <form onSubmit={handleSubmit} className='p-10 pt-6 space-y-12'>
          ...
          <div className='space-y-4'>
            ...
            <label className='text-[10px] font-black text-[#D4AF37] uppercase tracking-[0.4em] ml-1'>
              Visual Proof
            </label>
            ...
            <AnimatePresence mode="wait">
              ...
              {previewUrl ? (
                ...
                >
                  ...
                  <p className='mt-6 text-[10px] font-bold text-[#D4AF37]/30 group-hover:text-[#D4AF37] tracking-[0.5em] uppercase transition-colors'>
                    Upload Image
                  </p>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-10'>
            ...
            <div className='space-y-3'>
              ...
              <label className='text-[10px] font-bold text-[#A0A0A0] uppercase tracking-[0.3em] ml-1'>
                Item Name
              </label>
              ...
              <div className='relative h-full flex items-center justify-center gap-4'>
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <span className='text-[11px] font-black text-[#D4AF37] uppercase tracking-[0.5em]'>
                      Confirm & List Item
                    </span>
